...
const About = ({ darkMode }) => {
  return (
    <div className="px-10">
      ...
      <div className="lg:grid lg:grid-cols-2 p-10">
        <div>
          ...
          <div className="space-x-2">
            <NavLink to="/" className={"hover:text-blue-500 text-sm"}>
              Home
            </NavLink>
            <span>|</span>
        ...
        <div className="flex flex-col items-center lg:px-10">
          ...
          <p className={`text-gray-400`}>
            ...
            cutting-edge solutions. Our comprehensive training programs cover
            essential skills including web design and development, graphic
            design, content creation, social media management, and
            photography/videography. Whether you're looking to enhance your
            online presence or upskill your team, CoBrand Digital is your
            partner in navigating and thriving in the digital world.
          </p>
        </div>
        ...
        <div className="pt-10">
          <div className=" p-5">
            ...
            <p className="text-gray-400">
              ...
              digital marketing strategies tailored to the unique needs of your
              business.
            </p>
          </div>
      ...
      <div className="py-10">
        <h1 className="text-center text-2xl lg:text-4xl font-bold m-10">
          Meet Our Team Of <br />
          Experts
        </h1>
