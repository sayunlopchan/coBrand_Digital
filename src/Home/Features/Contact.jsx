  ...
  return (
    <div className={`${darkMode ? '' : 'contact-bg'}`}>
      ...
      <div className="lg:grid lg:grid-cols-2 p-10">
        <div className="space-y-5 p-10 ">
          ...
          <p className="text-gray-500 text-lg">
            If you need help with digital marketing or have any question
            regrading our company or service, you can directly contact us or
            visit our office
          </p>
        ...
        >
          ...
          <div>
            <input
              ...
              className="bg-white rounded-md border-2 w-full p-3"
            />
          </div>
          <div>
            <input
          ...
          <div>
            <input
              ...
              className="bg-white border-2 rounded-md w-full p-3"
            />
          </div>
          <div>
            <textarea
      ...
      <div className="lg:grid lg:grid-cols-2 p-10 flex flex-col justify-center items-center">
        ...
        <section>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3538.4000503366747!2d83.4524294743311!3d27.519027976291092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48c91b103b2e71fd%3A0x619e0f7f7ca77354!2sCoBrand%20Digital!5e0!3m2!1sen!2snp!4v1722337453868!5m2!1sen!2snp"
            allowFullScreen=""
            loading="lazy"
