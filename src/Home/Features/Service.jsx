    ...
    <div className="relative pt-20">
      ...
      <nav className=" relative text-center text-white mb-[50px] md:mb-[100px] ">
        ...
        <div className="space-x-2 text-sm text-gray-200 md:mt-9">
          <NavLink to="/" className="hover:text-blue-500 duration-300">
            Home
          </NavLink>
          <span>|</span>
      ...
      <div className="flex items-center justify-center relative pb-96  ">
        ...
        >
          <div className="flex items-center space-x-5 py-5 ">
            ...
            <h1 className="font-bold text-sm md:text-md lg:text-3xl">
              Growth, not just reach with Cobrand Digital.
            </h1>
          </div>
          <div className="h-[260px] md:px-16">
            <p className="text-gray-700 text-[14px] sm:text-sm md:text-md lg:text-lg">
              Dominate Nepal's digital market with targeted campaigns, engaging
              content, creative idea & Local SEO. We help businesses of all
              sizes climb the online mount everest and reach new heights. Ready
              to scale? Claim your peak in Nepal's digital landscape with our
              expert support.{" "}
            </p>
          </div>
        </div>
        ...
        <div className="md:grid md:grid-cols-2 ">
          <div className="relative mx-auto py-10">
            <img
              src={seoImg}
              alt="img"
              className="w-full md:w-[400px] lg:w-[400px]"
            />
            <img
              src={tab}
              alt="img"
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <button className="p-3 border-2 border-blue-600 hover:bg-blue-600 hover:text-white duration-300 rounded-lg">
              Get Your Social Media Optimized
            </button>
          </div>
        </div>
      </div>
      ...
      <div>
        <h1 className="text-center text-2xl font-bold">Check Our Services</h1>
      ...
      <div className="lg:grid lg:grid-cols-2  relative ">
        <div className="relative flex flex-col justify-center items-center gap-4 md:py-16 px-10">
          <h1 className="relative text-2xl md:text-5xl font-bold text-center  z-10">
          ...
          <button className="px-8 py-2 mt-10 bg-blue-500 font-bold border-2 border-blue-500 rounded-lg text-white hover:text-black hover:bg-white relative z-10">
            Get in Touch
          </button>
        </div>
        ...
        <div className="relative ">
          <img
            src={womenImage}
            alt="women img"
            className="relative mx-auto z-10 w-full"
          />
